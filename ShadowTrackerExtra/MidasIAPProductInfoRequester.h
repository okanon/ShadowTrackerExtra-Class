...
{
    _Bool _fromIntroPrice;
    MidasIapOrderInfo *_orderInfo;
    MidasIAPUserInfo *_userInfo;
    CDUnknownBlockType _completion;
    SKProductsRequest *_req;
    NSMutableSet *_ids;
    SKProductsRequest *_preheatReq;
    CDUnknownBlockType _preHeatCompletion;
}
...
- (void)preheatProuctInfo:(id)arg1 completion:(CDUnknownBlockType)arg2;
