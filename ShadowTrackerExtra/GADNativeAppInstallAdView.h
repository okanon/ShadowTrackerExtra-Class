...
@class GADAdChoicesView, GADEventContext, GADMediaView, GADNativeAppInstallAd, GADNativeAssetViewTracker, GADOverlayView, NSArray, NSString;

@interface GADNativeAppInstallAdView : UIView <GADNativeAdViewOverlayProtocol, GADEventContextSource>
{
