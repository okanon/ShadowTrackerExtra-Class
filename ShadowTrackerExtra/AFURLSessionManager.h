...
@interface AFURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    ...
    CDUnknownBlockType _taskDidFinishCollectingMetrics;
...
@property(copy, nonatomic) CDUnknownBlockType taskDidFinishCollectingMetrics; // @synthesize taskDidFinishCollectingMetrics=_taskDidFinishCollectingMetrics;
...
- (id)serverTrustErrorForServerTrust:(struct __SecTrust *)arg1 url:(id)arg2;
...
- (void)setTaskDidFinishCollectingMetricsBlock:(CDUnknownBlockType)arg1;
...
- (void)invalidateSessionCancelingTasks:(_Bool)arg1 resetSession:(_Bool)arg2;
