...
@class APMGPBEnumDescriptor, APMGPBOneofDescriptor, NSString;

@interface APMGPBFieldDescriptor : NSObject
{
    struct APMGPBMessageFieldDescription *description_;
    APMGPBOneofDescriptor *containingOneof_;
    SEL getSel_;
    SEL setSel_;
    SEL hasOrCountSel_;
    SEL setHasSel_;
    CDUnion_36c237b2 defaultValue_;
    Class msgClass_;
    union {
        APMGPBEnumDescriptor *enumDescriptor_;
        CDUnknownFunctionPointerType enumVerifier_;
    } enumHandling_;
}

@property(readonly, nonatomic) APMGPBOneofDescriptor *containingOneof; // @synthesize containingOneof=containingOneof_;
...
@property(readonly, nonatomic) APMGPBEnumDescriptor *enumDescriptor;
