...
#import "GADFramerateObserver.h"

@class GADMemoryUtilizationMonitor, GADNetworkUtilizationMonitor, GADScheduler, NSArray, NSDate, NSDictionary, NSMutableArray, NSObject<OS_dispatch_queue>, NSString;
