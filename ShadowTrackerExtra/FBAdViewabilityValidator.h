...
@class FBAdTimer, NSMutableDictionary, NSObject<FBAdViewabilityValidatorDelegate>, NSString, UIView;
...
- (void)stopViewabilityCheckAndStopObservingNotifications:(_Bool)arg1;
