...
@class FBAdExtraHint, FBAdImage, FBAdPlacementDefinition, FBAdProvider, FBDisplayAdController, FBNativeAdDataModel, NSHashTable, NSString, NSURL, UIView, UIViewController;
