...
@class APMGPBUInt32Array, APMGPBUInt64Array, NSArray, NSMutableArray;

@interface APMGPBUnknownField : NSObject <NSCopying>
{
    int number_;
    APMGPBUInt64Array *mutableVarintList_;
    APMGPBUInt32Array *mutableFixed32List_;
    APMGPBUInt64Array *mutableFixed64List_;
...
@property(readonly, nonatomic) APMGPBUInt64Array *fixed64List; // @synthesize fixed64List=mutableFixed64List_;
@property(readonly, nonatomic) APMGPBUInt32Array *fixed32List; // @synthesize fixed32List=mutableFixed32List_;
@property(readonly, nonatomic) APMGPBUInt64Array *varintList; // @synthesize varintList=mutableVarintList_;
