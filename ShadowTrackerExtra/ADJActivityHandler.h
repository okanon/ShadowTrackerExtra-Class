...
- (_Bool)isGdprForgottenI:(id)arg1;
- (_Bool)isEnabledI:(id)arg1;
- (void)setTrackingStateOptedOutI:(id)arg1;
- (void)setGdprForgetMeI:(id)arg1;
- (void)setPushTokenI:(id)arg1 pushToken:(id)arg2;
...
- (void)appWillOpenUrlI:(id)arg1 url:(id)arg2 clickTime:(id)arg3;
...
- (void)adRevenueI:(id)arg1 source:(id)arg2 payload:(id)arg3;
- (void)eventI:(id)arg1 event:(id)arg2;
- (void)endI:(id)arg1;
- (void)processCachedDeeplinkI:(id)arg1;
...
- (void)appWillOpenUrl:(id)arg1 withClickTime:(id)arg2;
- (id)adid;
