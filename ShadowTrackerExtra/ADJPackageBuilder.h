...
+ (void)parameters:(id)arg1 setData:(id)arg2 forKey:(id)arg3;
...
- (id)getAdRevenueParameters:(id)arg1 payload:(id)arg2;
...
- (id)buildAdRevenuePackage:(id)arg1 payload:(id)arg2;
