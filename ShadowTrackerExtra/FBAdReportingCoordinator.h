...
@class FBAdChoicesViewController, FBAdFunnelLogger, FBAdHiddenViewController, FBAdImage, FBAdReportingConfig, FBAdReportingOptionsViewController, NSArray, NSMutableArray, NSString, NSURL, UIView, UIViewController;
