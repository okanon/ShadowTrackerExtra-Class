...
@class APMGPBMessage, NSArray, NSData, NSString;

@protocol APMGPBMessageSignatureProtocol
...
- (int)getEnum;
- (APMGPBMessage *)getGroupAtIndex:(unsigned long long)arg1;
- (void)setGroup:(APMGPBMessage *)arg1;
- (APMGPBMessage *)getGroup;
- (APMGPBMessage *)getMessageAtIndex:(unsigned long long)arg1;
- (void)setMessage:(APMGPBMessage *)arg1;
- (APMGPBMessage *)getMessage;
