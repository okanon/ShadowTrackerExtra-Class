...
#import "FNFPlayerDisplayLayerDelegate.h"

@class CADisplayLink, CALayer<FNFPlayerDisplayLayer>, FNFPlayerFramesBuffer, FNFRenderingThread, NSError, NSObject<OS_dispatch_queue>, NSString;
