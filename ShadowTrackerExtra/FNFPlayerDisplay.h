...
#import "FNFPlayerDisplayLayerDelegate-Protocol.h"

@class CADisplayLink, CALayer, FNFPlayerFramesBuffer, FNFRenderingThread, NSError, NSString;
@protocol FNFDecompressionSession, FNFPlayerDisplayEngineDelegate, FNFPlayerDisplayLayer, FNFVideoPlaybackLoggingContext, OS_dispatch_queue;
...
- (void).cxx_destruct;
- (void)displayLayerIsReadyForDisplay:(_Bool)arg1;
...
- (id)initWithConfig:(CDStruct_a70a0991)arg1 renderingThread:(id)arg2 framesBuffer:(id)arg3 layer:(id)arg4;
- (id)initWithConfig:(CDStruct_a70a0991)arg1 andLayer:(id)arg2;
