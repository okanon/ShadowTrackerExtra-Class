...
@class MidasAFURLSessionManager, NSMutableData, NSProgress, NSString, NSURL;

@interface MidasAFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    MidasAFURLSessionManager *_manager;
...
@property(nonatomic) __weak MidasAFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
