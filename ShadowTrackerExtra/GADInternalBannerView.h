...
@class GADAdSource, GADBannerAd, GADCorrelator, GADEventContext, GADObserverCollection, GADRefreshTimer, GADResponseInfo, GADTargeting, GADVideoController, NSArray, NSObject, NSString, UIViewController;
