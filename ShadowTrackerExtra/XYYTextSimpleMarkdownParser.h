...
@class NSMutableArray, NSRegularExpression, NSString, UIColor, UIFont, XYYTextBorder;

@interface XYYTextSimpleMarkdownParser : NSObject <XYYTextParser>
{
    UIFont *_font;
