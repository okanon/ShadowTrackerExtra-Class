...
@protocol IMSDKMTAGCDAsyncSocketDelegate;

@interface IMSDKMTAGCDAsyncSocket : NSObject
{
    unsigned int flags;
    unsigned short config;
    id <IMSDKMTAGCDAsyncSocketDelegate> delegate;
    ...
    IMSDKMTAGCDAsyncReadPacket *currentRead;
    IMSDKMTAGCDAsyncWritePacket *currentWrite;
    unsigned long long socketFDBytesAvailable;
    IMSDKMTAGCDAsyncSocketPreBuffer *preBuffer;
