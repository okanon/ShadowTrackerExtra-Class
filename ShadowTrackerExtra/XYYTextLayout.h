...
@class NSArray, NSAttributedString, NSSet, XYYTextContainer, XYYTextLine;

@interface XYYTextLayout : NSObject <NSCoding>
{
    ...
    XYYTextContainer *_container;
    NSAttributedString *_text;
    struct __CTFramesetter *_frameSetter;
    struct __CTFrame *_frame;
    NSArray *_lines;
    XYYTextLine *_truncatedLine;
...
@property(retain, nonatomic) XYYTextLine *truncatedLine; // @synthesize truncatedLine=_truncatedLine;
...
@property(retain, nonatomic) XYYTextContainer *container; // @synthesize container=_container;
- (void).cxx_destruct;
