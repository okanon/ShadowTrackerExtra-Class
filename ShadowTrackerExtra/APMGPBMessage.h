...
@class APMGPBExtensionDescriptor, APMGPBFieldDescriptor, APMGPBUnknownFieldSet, NSMutableDictionary;

@interface APMGPBMessage : NSObject <NSSecureCoding, NSCopying>
{
    APMGPBUnknownFieldSet *unknownFields_;
    NSMutableDictionary *extensionMap_;
    NSMutableDictionary *autocreatedExtensionMap_;
    APMGPBMessage *autocreator_;
    APMGPBFieldDescriptor *autocreatorField_;
    APMGPBExtensionDescriptor *autocreatorExtension_;
    _Atomic id readOnlySemaphore_;
    struct APMGPBMessage_Storage *messageStorage_;
}
...
@property(copy, nonatomic) APMGPBUnknownFieldSet *unknownFields;
...
- (void)writeExtensionsToCodedOutputStream:(id)arg1 range:(struct APMGPBExtensionRange)arg2 sortedExtensions:(id)arg3;
