...
+ (void)launchInMainThreadWithInactive:(CDUnknownBlockType)arg1;
+ (_Bool)isInactive;
+ (_Bool)isMainThread;
...
+ (id)requestForPostPackage:(id)arg1 clientSdk:(id)arg2 parameters:(id)arg3 baseUrl:(id)arg4 queueSize:(unsigned long long)arg5;
+ (id)requestForGetPackage:(id)arg1 clientSdk:(id)arg2 parameters:(id)arg3 baseUrl:(id)arg4 basePath:(id)arg5;
+ (void)extractEventCallbackId:(id)arg1;
...
+ (void)sendGetRequest:(id)arg1 basePath:(id)arg2 prefixErrorMessage:(id)arg3 activityPackage:(id)arg4 responseDataHandler:(CDUnknownBlockType)arg5;
