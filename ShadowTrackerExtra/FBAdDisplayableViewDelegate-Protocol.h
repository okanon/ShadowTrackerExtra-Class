...
@class FBAdViewabilityValidator, NSDictionary, NSError, NSNumber, NSString, NSURL, UIEvent, UIView<FBAdDisplayable>;
...
- (void)adDisplayableViewDidLogImpression:(UIView<FBAdDisplayable> *)arg1 withViewabilityValidator:(FBAdViewabilityValidator *)arg2 withPageNumber:(NSNumber *)arg3 withPageTotal:(NSNumber *)arg4;
