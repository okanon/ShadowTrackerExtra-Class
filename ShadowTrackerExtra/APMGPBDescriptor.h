...
@class APMGPBFileDescriptor, NSArray, NSString;

@interface APMGPBDescriptor : NSObject <NSCopying>
{
    NSArray *fields_;
    NSArray *oneofs_;
    unsigned int storageSize_;
    Class messageClass_;
    APMGPBFileDescriptor *file_;
    _Bool wireFormat_;
    unsigned int extensionRangesCount_;
    const struct APMGPBExtensionRange *extensionRanges_;
}
...
@property(readonly, nonatomic) APMGPBFileDescriptor *file; // @synthesize file=file_;
@property(readonly, nonatomic) unsigned int extensionRangesCount; // @synthesize extensionRangesCount=extensionRangesCount_;
@property(readonly, nonatomic) const struct APMGPBExtensionRange *extensionRanges; // @synthesize extensionRanges=extensionRanges_;
...
@property(readonly) APMGPBDescriptor *containingType;
@property(readonly, copy, nonatomic) NSString *name;
- (void)setupMessageClassNameSuffix:(id)arg1;
- (void)setupContainingMessageClassName:(const char *)arg1;
- (void)setupExtensionRanges:(const struct APMGPBExtensionRange *)arg1 count:(int)arg2;
