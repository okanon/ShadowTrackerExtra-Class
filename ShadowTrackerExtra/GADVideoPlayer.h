...
@class AVPlayer, AVPlayerItem, GADAVPlayerItemLogger, GADObserverCollection, GADVideoConfiguration, GADWebAdView, NSMutableArray, NSNumber, NSOperationQueue, NSString;
@protocol GADAVPlayerItemProvider, GADEventContextSource, OS_dispatch_queue, OS_dispatch_semaphore;
