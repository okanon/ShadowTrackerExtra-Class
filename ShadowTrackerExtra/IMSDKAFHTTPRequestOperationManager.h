...
@class IMSDKAFHTTPRequestSerializer, IMSDKAFHTTPResponseSerializer, IMSDKAFNetworkReachabilityManager, IMSDKAFSecurityPolicy, NSOperationQueue, NSURL, NSURLCredential;
@protocol IMSDKAFURLRequestSerialization, IMSDKAFURLResponseSerialization, OS_dispatch_group, OS_dispatch_queue;
...
@interface IMSDKAFHTTPRequestOperationManager : NSObject <NSSecureCoding, NSCopying>
{
    ...
    IMSDKAFNetworkReachabilityManager *_reachabilityManager;
