...
@property(nonatomic) _Bool sd_cacheFLAnimatedImage;
@property(nonatomic) _Bool sd_predrawingEnabled;
@property(nonatomic) unsigned long long sd_optimalFrameCacheSize;
