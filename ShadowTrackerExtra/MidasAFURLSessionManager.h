...
@class MidasAFSecurityPolicy, NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration;
@protocol MidasAFURLResponseSerialization, OS_dispatch_group, OS_dispatch_queue;

@interface MidasAFURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    _Bool _attemptsToRecreateUploadTasksForBackgroundSessions;
    NSURLSession *_session;
    NSOperationQueue *_operationQueue;
    id <MidasAFURLResponseSerialization> _responseSerializer;
...
@property(retain, nonatomic) id <MidasAFURLResponseSerialization> responseSerializer; // @synthesize responseSerializer=_responseSerializer;
