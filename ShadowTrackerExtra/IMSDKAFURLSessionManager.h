...
@class IMSDKAFNetworkReachabilityManager, IMSDKAFSecurityPolicy, NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration;
@protocol IMSDKAFURLResponseSerialization, OS_dispatch_group, OS_dispatch_queue;
...
@interface IMSDKAFURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    ...
    id <IMSDKAFURLResponseSerialization> _responseSerializer;
