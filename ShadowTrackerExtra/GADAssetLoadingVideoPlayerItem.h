...
#import "GADAVPlayerItemProvider.h"

@class AVAssetResourceLoadingRequest, AVPlayerItem, GADKeyValueObserverController, GADResourceBuffer, GADVideoAssetLoader, GADVideoConfiguration, GADVideoPlayer, NSObject<OS_dispatch_queue>, NSString, NSTimer, NSURL;
