...
#import "XYYTextAsyncLayerDelegate-Protocol.h"
#import "XYYTextDebugTarget-Protocol.h"

@class NSArray, NSAttributedString, NSMutableArray, NSMutableAttributedString, NSString, NSTimer, UIBezierPath, UIColor, UIFont, XYYTextContainer, XYYTextDebugOption, XYYTextHighlight, XYYTextLayout;
@protocol XYYTextLinePositionModifier, XYYTextParser;

@interface XYYLabel : UIView <XYYTextDebugTarget, XYYTextAsyncLayerDelegate, NSCoding>
{
    ...
    XYYTextLayout *_shrinkInnerLayout;
    XYYTextLayout *_shrinkHighlightLayout;
...
@property(retain, nonatomic) XYYTextLayout *textLayout;
