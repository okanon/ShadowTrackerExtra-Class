...
@class FBAdBlurredOverlayView, FBAdCTAButton, FBAdCommandProcessor, FBAdLabel, FBInterstitialAdToolbarView, FBNativeAdDataModel, NSString, UIImageView, UIViewController;
...
- (void)dealloc;
- (id)initWithPlacementID:(id)arg1 adDataModel:(id)arg2 rootViewController:(id)arg3 toolbarView:(id)arg4;
