...
@protocol FNFAVPlayer, FNFDecompressionSession, FNFPlayerDisplayEngineDelegate, FNFPlayerGLRenderer, FNFVideoPlaybackLoggingContext, OS_dispatch_queue;
...
- (id)initWithConfig:(CDStruct_a70a0991)arg1 renderingThread:(id)arg2 framesBuffer:(id)arg3;
