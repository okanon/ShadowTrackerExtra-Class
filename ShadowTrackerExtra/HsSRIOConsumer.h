...
@interface HsSRIOConsumer : NSObject
{
    ...
    _Bool _unmaskBytes;
    _Bool _inflatedBytes;
}

@property(readonly, nonatomic) _Bool inflatedBytes; // @synthesize inflatedBytes=_inflatedBytes;
...
- (void).cxx_destruct;
- (void)resetWithScanner:(CDUnknownBlockType)arg1 handler:(CDUnknownBlockType)arg2 bytesNeeded:(unsigned long long)arg3 readToCurrentFrame:(_Bool)arg4 unmaskBytes:(_Bool)arg5 infatedBytes:(_Bool)arg6;
