...
@protocol VLCollectionViewDelegateWaterfallLayout;

@interface VLWaterFallLayout : UICollectionViewLayout
{
    ...
    id <VLCollectionViewDelegateWaterfallLayout> _delegate;
...
@property(nonatomic) __weak id <VLCollectionViewDelegateWaterfallLayout> delegate; // @synthesize delegate=_delegate;
