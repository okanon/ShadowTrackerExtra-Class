...
@class APMGPBEnumDescriptor, NSString;

@interface APMGPBExtensionDescriptor : NSObject <NSCopying>
{
    struct APMGPBExtensionDescription *description_;
...
- (void)dealloc;
- (id)initWithExtensionDescription:(struct APMGPBExtensionDescription *)arg1;
