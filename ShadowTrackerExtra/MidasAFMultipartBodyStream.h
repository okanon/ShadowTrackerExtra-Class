...
@class MidasAFHTTPBodyPart, NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString;

@interface MidasAFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    MidasAFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) MidasAFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
