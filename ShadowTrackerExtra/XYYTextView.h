...
#import "XYYTextDebugTarget-Protocol.h"
#import "XYYTextKeyboardObserver-Protocol.h"

@class NSArray, NSAttributedString, NSDataDetector, NSDictionary, NSMutableArray, NSMutableAttributedString, NSString, NSTimer, UIColor, UIFont, UIImageView, UITextPosition, UITextRange, UIView, XYYTextContainer, XYYTextContainerView, XYYTextDebugOption, XYYTextHighlight, XYYTextLayout, XYYTextMagnifier, XYYTextRange, XYYTextSelectionView;
@protocol UITextInputDelegate, UITextInputTokenizer, XYYTextLinePositionModifier, XYYTextParser, XYYTextViewDelegate;

@interface XYYTextView : UIScrollView <UIScrollViewDelegate, UIAlertViewDelegate, XYYTextDebugTarget, XYYTextKeyboardObserver, UITextInput>
{
    XYYTextRange *_selectedTextRange;
    XYYTextRange *_markedTextRange;
    id <XYYTextViewDelegate> _outerDelegate;
    UIImageView *_placeHolderView;
    NSMutableAttributedString *_innerText;
    NSMutableAttributedString *_delectedText;
    XYYTextContainer *_innerContainer;
    XYYTextLayout *_innerLayout;
    XYYTextContainerView *_containerView;
    XYYTextSelectionView *_selectionView;
    XYYTextMagnifier *_magnifierCaret;
    XYYTextMagnifier *_magnifierRanged;
    NSMutableAttributedString *_typingAttributesHolder;
    NSDataDetector *_dataDetector;
    double _magnifierRangedOffset;
    struct _NSRange _highlightRange;
    XYYTextHighlight *_highlight;
    XYYTextLayout *_highlightLayout;
    XYYTextRange *_trackingRange;
...
@property(copy, nonatomic) id <XYYTextLinePositionModifier> linePositionModifier; // @synthesize linePositionModifier=_linePositionModifier;
...
@property(retain, nonatomic) id <XYYTextParser> textParser; // @synthesize textParser=_textParser;
...
@property(nonatomic) __weak id <XYYTextViewDelegate> delegate;
...
@property(readonly, nonatomic) XYYTextLayout *textLayout;
@property(copy, nonatomic) XYYTextDebugOption *debugOption;
