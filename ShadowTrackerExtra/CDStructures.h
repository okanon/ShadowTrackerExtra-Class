...
struct GCloudVoiceEngine {
    ...
    struct map<std::basic_string<char>, gcloud_voice::MemVol, std::less<std::basic_string<char>>, std::allocator<std::pair<const std::basic_string<char>, gcloud_voice::MemVol>>> _field8;
    ...
    struct basic_string<char, std::char_traits<char>, std::allocator<char>> _field49;
    struct basic_string<char, std::char_traits<char>, std::allocator<char>> _field50;
    int _field51;
    int _field52;
    struct basic_string<char, std::char_traits<char>, std::allocator<char>> _field53;
    struct basic_string<char, std::char_traits<char>, std::allocator<char>> _field54;
    struct basic_string<char, std::char_traits<char>, std::allocator<char>> _field55;
    _Bool _field56;
    _Bool _field57;
    int _field58;
    _Bool _field59;
    ...
    struct basic_string<char, std::char_traits<char>, std::allocator<char>> _field62[16];
    ...
    _Bool _field70;
    int _field71;
    struct map<std::basic_string<char>, int, std::less<std::basic_string<char>>, std::allocator<std::pair<const std::basic_string<char>, int>>> _field72;
    int _field73;
    int _field74;
...
struct GCloudVoiceReportPlayer {
    CDUnknownFunctionPointerType *_field1;
    CDUnknownFunctionPointerType *_field2;
    struct map<unsigned int, gcloud_voice::GCloudVoiceReportPlayer::PlayerData, std::less<unsigned int>, std::allocator<std::pair<const unsigned int, gcloud_voice::GCloudVoiceReportPlayer::PlayerData>>> _field3;
...
struct _Rb_tree<std::basic_string<char>, std::pair<const std::basic_string<char>, gcloud_voice::MemVol>, std::_Select1st<std::pair<const std::basic_string<char>, gcloud_voice::MemVol>>, std::less<std::basic_string<char>>, std::allocator<std::pair<const std::basic_string<char>, gcloud_voice::MemVol>>> {
...
struct _Rb_tree<unsigned int, std::pair<const unsigned int, gcloud_voice::GCloudVoiceReportPlayer::PlayerData>, std::_Select1st<std::pair<const unsigned int, gcloud_voice::GCloudVoiceReportPlayer::PlayerData>>, std::less<unsigned int>, std::allocator<std::pair<const unsigned int, gcloud_voice::GCloudVoiceReportPlayer::PlayerData>>> {
...
struct map<std::basic_string<char>, gcloud_voice::MemVol, std::less<std::basic_string<char>>, std::allocator<std::pair<const std::basic_string<char>, gcloud_voice::MemVol>>> {
    struct _Rb_tree<std::basic_string<char>, std::pair<const std::basic_string<char>, gcloud_voice::MemVol>, std::_Select1st<std::pair<const std::basic_string<char>, gcloud_voice::MemVol>>, std::less<std::basic_string<char>>, std::allocator<std::pair<const std::basic_string<char>, gcloud_voice::MemVol>>> _field1;
};
...
struct map<unsigned int, gcloud_voice::GCloudVoiceReportPlayer::PlayerData, std::less<unsigned int>, std::allocator<std::pair<const unsigned int, gcloud_voice::GCloudVoiceReportPlayer::PlayerData>>> {
    struct _Rb_tree<unsigned int, std::pair<const unsigned int, gcloud_voice::GCloudVoiceReportPlayer::PlayerData>, std::_Select1st<std::pair<const unsigned int, gcloud_voice::GCloudVoiceReportPlayer::PlayerData>>, std::less<unsigned int>, std::allocator<std::pair<const unsigned int, gcloud_voice::GCloudVoiceReportPlayer::PlayerData>>> _field1;
};
