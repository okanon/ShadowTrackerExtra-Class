...
@protocol TSEAccount, TSEAutoCompletion, TSEGeoTagging, TSEImageDownloader, TSENetworking, TSEScribe, TSETweetShareViewControllerDelegate;
...
- (void).cxx_destruct;
- (id)initWithInitialTweet:(id)arg1 accounts:(id)arg2 initiallySelectedAccount:(id)arg3 geoTagging:(id)arg4 autoCompletion:(id)arg5 imageDownloader:(id)arg6 localizedResources:(Class)arg7 networking:(id)arg8 twitterText:(Class)arg9 wordRangeCalculator:(Class)arg10 scribe:(id)arg11 delegate:(id)arg12;
