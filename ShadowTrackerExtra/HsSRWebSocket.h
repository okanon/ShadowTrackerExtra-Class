...
@class HsSRDelegateController, HsSRIOConsumerPool, HsSRProxyConnect, HsSRSecurityPolicy, HsSRWebSocketDeflater, HsSRWebSocketInflater, NSArray, NSInputStream, NSMutableArray, NSMutableData, NSMutableSet, NSOperationQueue, NSOutputStream, NSString, NSURL, NSURLRequest;
@protocol HsSRWebSocketDelegate, OS_dispatch_data, OS_dispatch_queue;
